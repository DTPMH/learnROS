...
void publish_waypoints() {
    ...
    waypoints.poses.insert(waypoints.poses.begin(), init_pose);//在waypoints开头插入init_pose点
    // pub2.publish(waypoints);
    waypoints.poses.clear();//清楚waypoint
}
...
int main(int argc, char** argv) {
    ...
    ros::Subscriber sub3 = n.subscribe("traj_start_trigger", 10, traj_start_trigger_callback);//无发布节点
