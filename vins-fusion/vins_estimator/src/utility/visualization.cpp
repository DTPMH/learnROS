...
/*修改的
    ...
    odometry.pose.pose.orientation.x = Q.y();
    odometry.pose.pose.orientation.y = Q.z();
    odometry.pose.pose.orientation.z = -Q.x();
    odometry.pose.pose.orientation.w = Q.w();
    odometry.twist.twist.linear.x = V.y();
    odometry.twist.twist.linear.y = V.z();
    odometry.twist.twist.linear.z = -V.x();
*/
...
/*  
        ...
        odometry.pose.pose.position.y = estimator.Ps[WINDOW_SIZE].z();
        odometry.pose.pose.position.z = -estimator.Ps[WINDOW_SIZE].x();
        odometry.pose.pose.orientation.x = tmp_Q.y();
        odometry.pose.pose.orientation.y = tmp_Q.z();
        odometry.pose.pose.orientation.z = -tmp_Q.x();
...
/*        
        ...
        odometry.twist.twist.linear.y = estimator.Vs[WINDOW_SIZE].z();
        odometry.twist.twist.linear.z = -estimator.Vs[WINDOW_SIZE].x();
 */       
//以上为自己修改的
...
//*/
/*修改的
        pose_marker.x = correct_pose.y();
        pose_marker.y = correct_pose.z();
        pose_marker.z = -correct_pose.x();
*/
...
/*修改的
        ...
        odometry.pose.pose.position.y = P.z();
        odometry.pose.pose.position.z = -P.x();
        odometry.pose.pose.orientation.x = R.y();
        odometry.pose.pose.orientation.y = R.z();
        odometry.pose.pose.orientation.z = -R.x();
        odometry.pose.pose.orientation.w = R.w();
*/
...
//*/
/*修改的
    odometry.pose.pose.position.x = estimator.tic[0].y();
    odometry.pose.pose.position.y = estimator.tic[0].z();
    odometry.pose.pose.position.z = -estimator.tic[0].x();
    Quaterniond tmp_q{estimator.ric[0]};
    odometry.pose.pose.orientation.x = tmp_q.y();
    odometry.pose.pose.orientation.y = tmp_q.z();
    odometry.pose.pose.orientation.z = -tmp_q.x();
